      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.inner} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.logoBlock}>
            ...
            <Text style={styles.logoText}>滴搭 <Text style={styles.logoAccent}>Darlink</Text></Text>
          ...
          <View style={styles.card}>
            ...
            <PressableScale onPress={handleSubmit} disabled={loading} haptic="medium" scaleDown={0.97} style={styles.btnWrap}>
              <LinearGradient
...
const styles = StyleSheet.create({
  ...
  flex: { flex: 1 },
  orb1: { position: 'absolute', top: -60, left: -60, width: ORB, height: ORB, borderRadius: ORB / 2, backgroundColor: Colors.pink, opacity: 0.12 },
  orb2: { position: 'absolute', bottom: 80, right: -80, width: ORB + 60, height: ORB + 60, borderRadius: (ORB + 60) / 2, backgroundColor: Colors.blue, opacity: 0.10 },
  ...
  logoCircleBlue: { position: 'absolute', left: 4, width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.blue, opacity: 0.6 },
  logoCirclePink: { position: 'absolute', right: 4, width: 36, height: 36, borderRadius: 18, backgroundColor: Colors.pink, opacity: 0.6 },
  ...
  badge: { alignSelf: 'center', backgroundColor: Colors.bgWhite, borderWidth: 1, borderColor: Colors.border, borderRadius: Radii.full, paddingHorizontal: Spacing.md, paddingVertical: 6, ...Shadows.sm },
  badgeText: { fontSize: 12, color: Colors.study, fontWeight: '600' },
  card: { backgroundColor: Colors.bgWhite, borderRadius: Radii['3xl'], padding: Spacing.lg, gap: Spacing.md, borderWidth: 1, borderColor: Colors.border, ...Shadows.md },
  ...
  input: { backgroundColor: Colors.bg, borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radii.lg, padding: Spacing.md, fontSize: 15, color: Colors.text },
  ...
  dropdown: { backgroundColor: Colors.bgWhite, borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radii.lg, overflow: 'hidden', ...Shadows.sm },
  ...
  btnWrap: { marginTop: 4 },
  btn: { borderRadius: Radii.full, padding: Spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
